...
def left_click(event):
	...
	if len(vertex_list) > 1:
		section = brezenham_int(draw_color, vertex_list[-2].x, vertex_list[-2].y, vertex_list[-1].x, vertex_list[-1].y)
		draw_section(section)


def return_click(event):
	if len(vertex_list) > 2:
		section = brezenham_int(draw_color, vertex_list[-1].x, vertex_list[-1].y, vertex_list[0].x, vertex_list[0].y)
		draw_section(section)
		vertex_list.clear()
...
root = tk.Tk()
root.title("Построчный алгоритм затравочного заполнения для любых замкнутых. Л/р 6")
...
for i in range(len(cfg.MODES)):
	mode_radios.append(tk.Radiobutton(data_frame, text = cfg.MODES[i], bg = cfg.ADD_COLOUR, fg = cfg.MAIN_COLOUR, variable = mode,
		value = i))
# index = list(points_listbox.curselection())

modes_label = tk.Label(data_frame, text = "Режимы", font = ("Consolas", 14), bg = cfg.MAIN_COLOUR, fg = cfg.ADD_COLOUR,
	relief = tk.GROOVE)

colour_label = tk.Label(data_frame, text = "Цвет границы", font = ("Consolas", 14), bg = cfg.MAIN_COLOUR, fg = cfg.ADD_COLOUR,
	relief = tk.GROOVE)

fill_color_label = tk.Label(data_frame, text = "Цвет закраски", font = ("Consolas", 14), bg = cfg.MAIN_COLOUR, fg = cfg.ADD_COLOUR, 
	relief = tk.GROOVE)
...
point_btn = tk.Button(data_frame, text = "Добавить точку", font = ("Consolas", 14), bg = cfg.MAIN_COLOUR, fg = cfg.ADD_COLOUR,
	command = put_point, activebackground = cfg.ADD_COLOUR, activeforeground = cfg.MAIN_COLOUR)
solve_btn = tk.Button(data_frame, text = "Закрасить", font = ("Consolas", 14), bg = cfg.MAIN_COLOUR, fg = cfg.ADD_COLOUR,
	command = solve, activebackground = cfg.ADD_COLOUR, activeforeground = cfg.MAIN_COLOUR)
time_btn = tk.Button(data_frame, text = "Измерить время", font = ("Consolas", 14), bg = cfg.MAIN_COLOUR, fg = cfg.ADD_COLOUR,
	command = get_time, activebackground = cfg.ADD_COLOUR, activeforeground = cfg.MAIN_COLOUR)
...
colour_btn = tk.Button(data_frame, text = "", font = ("Consolas", 14), bg = cfg.DEFAULT_COLOUR, fg = cfg.ADD_COLOUR,
	command = change_color, relief = tk.GROOVE)
fill_color_btn = tk.Button(data_frame, text = "", font = ("Consolas", 14), bg = cfg.DEFAULT_COLOUR, fg = cfg.ADD_COLOUR,
	command = change_fill_color, relief = tk.GROOVE)
...
offset = 0
modes_label.place(x = 0, y = cfg.DATA_HEIGHT * offset // cfg.ROWS, width = cfg.DATA_WIDTH, height = cfg.DATA_HEIGHT // cfg.ROWS)
offset += 1
for i in range(len(mode_radios)):
	mode_radios[i].place(x = 0, y = cfg.SLOT_HEIGHT * offset + i * cfg.SLOT_HEIGHT, width = cfg.DATA_WIDTH, height = cfg.SLOT_HEIGHT)
offset += 3

colour_label.place(x = 0, y = cfg.DATA_HEIGHT * offset // cfg.ROWS, width = cfg.DATA_WIDTH, height = cfg.DATA_HEIGHT // cfg.ROWS)
offset += 1

colour_btn.place(x = 0, y = cfg.SLOT_HEIGHT * offset, width = cfg.DATA_WIDTH, height = cfg.SLOT_HEIGHT)
offset += 2

fill_color_label.place(x = 0 , y = cfg.DATA_HEIGHT * offset // cfg.ROWS, width = cfg.DATA_WIDTH, height = cfg.DATA_HEIGHT // cfg.ROWS)
offset += 1

fill_color_btn.place(x = 0, y = cfg.SLOT_HEIGHT * offset, width = cfg.DATA_WIDTH, height = cfg.SLOT_HEIGHT)
offset += 2
...
point_btn.place(x = 0, y = cfg.SLOT_HEIGHT * offset, width = cfg.DATA_WIDTH, height = cfg.SLOT_HEIGHT)
